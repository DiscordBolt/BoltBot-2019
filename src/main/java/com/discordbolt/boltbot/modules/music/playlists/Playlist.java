package com.discordbolt.boltbot.modules.music.playlists;
...
public class Playlist implements Comparable<Playlist> {
    ...
    public IUser getOwner() {
        return MusicModule.getClient().getUserByID(ownerID);
    }
    ...
    public IGuild getGuild() {
        return MusicModule.getClient().getGuildByID(guildID);
    }

    public ArrayList<IUser> getContributors() {
        return contributors.stream().map(u -> MusicModule.getClient().getUserByID(u)).collect(Collectors.toCollection(ArrayList::new));
    }
