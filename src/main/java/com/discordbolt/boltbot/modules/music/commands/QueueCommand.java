...
public class QueueCommand {
    ...
    @BotCommand(command = {"queue", "clear"}, module = MusicModule.MODULE, description = "Remove all songs from the queue", usage = "Queue clear", allowedChannels = "music", args = 2)
    public static void queueClearCommand(CommandContext cc) throws CommandException {
        MusicModule.getVoiceManager().clearQueue(cc.getGuild(), cc.getAuthor());
    }
