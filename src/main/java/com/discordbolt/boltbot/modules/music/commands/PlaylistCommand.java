...
public class PlaylistCommand {
    ...
    @BotCommand(command = {"playlist", "delete"}, module = MusicModule.MODULE, aliases = "pl", description = "Delete a playlist", usage = "Playlist delete [name]", allowedChannels = "music", minArgs = 3, maxArgs = 100)
    public static void playlistDeleteCommand(CommandContext cc) throws CommandException {
        MusicModule.getPlaylistManager().deletePlaylist(getPlaylistName(cc), cc.getAuthor());
