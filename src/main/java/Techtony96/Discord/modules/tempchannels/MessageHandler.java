...
public class MessageHandler {
    ...
    @BotCommand(command = "create", description = "Create a voice channel", usage = "!Create -Private [Channel Name]", minArgs = 2, maxArgs = 100)
    ...
    @BotCommand(command = "add", description = "Give users permission to join your temporary channel.", usage = "!Add @User1 @User2", minArgs = 2, maxArgs = 100)
    ...
    @BotCommand(command = "delete", description = "Delete your temporary voice channel.", usage = "!Delete", args = 1)
